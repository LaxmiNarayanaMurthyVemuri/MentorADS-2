...
public class SeamCarver {
    ...
    private void vertTopologicalSort(double[][] energies) {
    ...
    private int[] findMinVertPath(double[][] energies) {
        int h = energies.length, w = energies[0].length;
    ...
    public int[] findHorizontalSeam() {
        double[][] transNrgs = transpose(initEnergies());
        return findMinVertPath(transNrgs);
    }
    // sequence of indices for vertical seam
    public int[] findVerticalSeam() {
        double[][] nrgs = initEnergies();
